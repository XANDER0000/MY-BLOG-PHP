 ...
 <div class="enter">
  <div class="container">
   <div class="enter__wrapper">
    <div class="enter__header">Регистрация</div>
    <form action="" class="enter__form">
     ...
     <label for="">
      Повторите пароль
      <input placeholder="Повторите ваш пароль" type="text">
     </label>
     <div class="enter__form-buttons">
      <button class="enter__btn">Регистрация</button>
      <a class="enter__link" href="">Войти</a>
     </div>
    </form>
   </div><!--ENTER__WRAPPER ----------------------->
  </div><!--CONTAINER ----------------------->
